...
tools: Read, Grep, Glob, Bash, mcp__google-sheets__get_sheet_data, mcp__google-sheets__get_multiple_sheet_data, mcp__google-sheets__find_in_spreadsheet, mcp__google-sheets__list_sheets
---
